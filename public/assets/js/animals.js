...
const getAnimals = (formData = {}) => {
  ...
  //when using fetch have to see if ok property is true or false
  fetch(queryUrl)
    .then((response) => {
      if (!response.ok) {
    ...
    //JSON the information and send our array of data to printResults() where it generates cards for each animal and prints them to the page
    .then((animalData) => {
